  ...
  return (<>
    ...
    <a href="/brochure.pdf" target="_blank" rel="noopener noreferrer"> <Button color="red" className="my-2 sm:my-0 mx-2 sm:mx-5">Download</Button></a>
      ...
      <div className="mx-auto w-full max-w-7xl px-8 z-40">
        <div className="flex justify-between z-40 mt-28">
          <div className="mx-auto grid w-full grid-cols-1 gap-8 py-12 xs:grid-cols-2 md:grid-cols-2 z-40 lg:grid-cols-4">
                ...
                <li>
                  <div className="flex items-center text-right my-auto">
                    <img
                      ...
                      width="20px"
                    />
                    <a className="hover:text-blue-100 duration-100" href="tel:9096069751">+91 9096069751</a>
                  </div>
                </li>
              </ul>
            </div>
            <a
              ...
              href="https://maps.app.goo.gl/pCf2sobyyXLd41Ux8"
            >
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center font-normal  underline-offset-2 text-white md:mb-0"
          >
            &copy; {currentYear}{" "}
            <a href="mailto:mjxworks@gmail.com">
              Developed by Mrityunjay Shrivastava,
              <span className="text-blue-500 hover:text-blue-100 duration-100"> mjxworks@gmail.com</span>. All
              Rights Reserved.
            </a>
          </Typography>
